...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=governance&notebook=00-automated-upgrade-with-UCX&demo_name=uc-05-upgrade&event=VIEW">
