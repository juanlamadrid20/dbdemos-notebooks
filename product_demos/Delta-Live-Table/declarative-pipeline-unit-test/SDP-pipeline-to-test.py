...
# MAGIC %md Open the [/sdp-python/transformations/02-silver.py]($./sdp-python/transformations/02-silver.py) to check out the full silver layer code.
...
# MAGIC %md Open the [/sdp-python/transformations/03-gold.py]($./sdp-python/transformations/03-gold.py) to check out the full gold layer code.
